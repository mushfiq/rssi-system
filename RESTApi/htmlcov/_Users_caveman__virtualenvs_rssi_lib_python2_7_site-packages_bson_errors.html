...
<head>
    ...
    <title>Coverage for /Users/caveman/.virtualenvs/rssi/lib/python2.7/site-packages/bson/errors: 100%</title>
...
<div id='header'>
    <div class='content'>
        <h1>Coverage for <b>/Users/caveman/.virtualenvs/rssi/lib/python2.7/site-packages/bson/errors</b> :
...
<p id='t15' class='stm run hide_run'><span class='str'>&quot;&quot;&quot;Exceptions raised by the BSON package.&quot;&quot;&quot;</span><span class='strut'>&nbsp;</span></p>
<p id='t16' class='pln'><span class='strut'>&nbsp;</span></p>
<p id='t17' class='pln'><span class='strut'>&nbsp;</span></p>
<p id='t18' class='stm run hide_run'><span class='key'>class</span> <span class='nam'>BSONError</span><span class='op'>(</span><span class='nam'>Exception</span><span class='op'>)</span><span class='op'>:</span><span class='strut'>&nbsp;</span></p>
<p id='t19' class='pln'>&nbsp; &nbsp; <span class='str'>&quot;&quot;&quot;Base class for all BSON exceptions.</span><span class='strut'>&nbsp;</span></p>
...
<p id='t23' class='stm run hide_run'><span class='key'>class</span> <span class='nam'>InvalidBSON</span><span class='op'>(</span><span class='nam'>BSONError</span><span class='op'>)</span><span class='op'>:</span><span class='strut'>&nbsp;</span></p>
<p id='t24' class='pln'>&nbsp; &nbsp; <span class='str'>&quot;&quot;&quot;Raised when trying to create a BSON object from invalid data.</span><span class='strut'>&nbsp;</span></p>
...
<p id='t28' class='stm run hide_run'><span class='key'>class</span> <span class='nam'>InvalidStringData</span><span class='op'>(</span><span class='nam'>BSONError</span><span class='op'>)</span><span class='op'>:</span><span class='strut'>&nbsp;</span></p>
<p id='t29' class='pln'>&nbsp; &nbsp; <span class='str'>&quot;&quot;&quot;Raised when trying to encode a string containing non-UTF8 data.</span><span class='strut'>&nbsp;</span></p>
...
<p id='t33' class='stm run hide_run'><span class='key'>class</span> <span class='nam'>InvalidDocument</span><span class='op'>(</span><span class='nam'>BSONError</span><span class='op'>)</span><span class='op'>:</span><span class='strut'>&nbsp;</span></p>
<p id='t34' class='pln'>&nbsp; &nbsp; <span class='str'>&quot;&quot;&quot;Raised when trying to create a BSON object from an invalid document.</span><span class='strut'>&nbsp;</span></p>
...
<p id='t38' class='stm run hide_run'><span class='key'>class</span> <span class='nam'>InvalidId</span><span class='op'>(</span><span class='nam'>BSONError</span><span class='op'>)</span><span class='op'>:</span><span class='strut'>&nbsp;</span></p>
<p id='t39' class='pln'>&nbsp; &nbsp; <span class='str'>&quot;&quot;&quot;Raised when trying to create an ObjectId from invalid data.</span><span class='strut'>&nbsp;</span></p>
